...
class AnimatedLine(QObject):
    def __init__(self):
        ...
        #self.setLine(0, 0, 200, 200)
        #self.setPen(QPen(self._color, 5))
        ...
        path = QPainterPath()
        ctr_point1 = QPointF(50, 200)
        ctr_point2 = QPointF(150, 200)
    ...
    def setColor(self, color):
        print("UPDATING COLOR YO!", color)
        self._color = color
        pen = QPen()
        self.line.setPen(QPen(self._color, 5))
